...
const AddRoom = () => {
  ...
  return (
    <form>
        <Title align="left" font="outfit" title="Add Room" subTitle="Fill in the details carefull and accurated from details,pricing and amenities,to enhance the user booking experience." />
