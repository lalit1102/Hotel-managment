  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24'>
      ...
      <div className='flex flex-col items-start text-left'>
        ...
        <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take advantages of our limited-time offers and special packages to enhance your stay and crate unforgettable memories</p>
      </div> 
        ...
        {roomsDummyData.map((room)=>(
          <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
            ...
            <div className='md:w-1/2 flex flex-col gap-2'>
              ...
              <div className='flex items-center gap-1 text-gray-500 mt-5 text-sm'>
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg\:mt-16">
        <div className={`flex items-center justify-between px-4 py-2.5 min-lg\:border-b border-gray-300 ${openFilter && "border-b"}`}>
